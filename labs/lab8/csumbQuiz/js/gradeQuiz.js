$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        //var score = 0;//moved from line 8
        score = 0;
        //Get answers
        var answer1 = $("input[name='question1']").val().trim();
        var answer2 = $("input[name='question2']:checked").val();
        var answer3 = $("select[name='question3']").val();
        ...
        $("#question3-feedback").append("The answer is <strong>Dr. Andrew Lawson</strong>");
        ...
        $("#question4-feedback").append("The answer is <strong>93955</strong>");
